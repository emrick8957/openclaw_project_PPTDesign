...
outline_path = work / 'outline_v0.3.md'
copy_path = work / 'page_copy_v0.3.md'
design_path = work / 'page_design_v0.3.md'
deck_path = work / 'deck_spec_v0.3.json'

outline = outline_path.read_text(encoding='utf-8')
page_copy = copy_path.read_text(encoding='utf-8')
page_design = design_path.read_text(encoding='utf-8')
deck = json.loads(deck_path.read_text(encoding='utf-8'))

ranges = [(1, 10), (11, 16)]
base = 'huawei_cloud_competitiveness_2026-05-04_v0.3'
...
for start, end in ranges:
    ...
    (out_dir / '01_outline.md').write_text(outline_subset, encoding='utf-8')
    (out_dir / '02_page_copy.md').write_text(copy_subset, encoding='utf-8')
    (out_dir / '03_page_design.md').write_text(design_subset, encoding='utf-8')
